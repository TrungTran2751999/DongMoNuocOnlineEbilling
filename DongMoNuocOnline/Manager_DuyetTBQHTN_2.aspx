<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true"
	CodeBehind="Manager_DuyetTBQHTN_2.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.BaoCao.Manager_DuyetTBQHTN_2" %>
...
<asp:Content ID="content" ContentPlaceHolderID="mainCPH" runat="server">
     ...
     <asp:UpdatePanel ID="UptPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="crmcontainer" id="contNhacNo" runat="server" visible="false">  
                ...
                <button id="" onclick="huyPheDuyetHangLoat()">Hủy duyệt thông báo quá hạn lần 2</button>    
    ...
    <script>
        ...
        function callApiDuyetTBQH2() {
            ...
            return $.ajax({
                url: "/Forms/DongMoNuocOnline/Manager_DuyetTBQHTN_2.aspx/PheDuyetThongBaoQuaHanLan2",
                type: "POST",
        ...
        function callApiHuyPheDuyetTBQH2() {
            ...
            return $.ajax({
                url: "/Forms/DongMoNuocOnline/Manager_DuyetTBQHTN_2.aspx/HuyPheDuyetThongBaoQuaHanLan2",
                type: "POST",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function getAllKhachHangNo() {
            ...
            return $.ajax({
                url: "/Forms/DongMoNuocOnline/Manager_DuyetTBQHTN_2.aspx/GetListTBQHLan2",
                type: "POST",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ dieuKienLocStr: data }),
