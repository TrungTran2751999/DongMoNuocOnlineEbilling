<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true"
	CodeBehind="Manager_DuyetTNCN.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.BaoCao.ManagerDuyetTNCN" %>
...
<%--    <script type="text/javascript" src="../../content/kyso/vendor/pdfsignature-2.0.0.6/pdfsignature.js"></script>--%>
     ...
     <asp:UpdatePanel ID="UptPanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="crmcontainer" id="contNhacNo" runat="server" visible="false">  
                ...
                <button id="" onclick="huyPheDuyetHangLoat()">Hủy duyệt tạm ngừng cấp nước</button>
    ...
    <script>
        ...
        function callApiHuyPheDuyetTNCN() {
            ...
            return $.ajax({
                url: "/Forms/DongMoNuocOnline/Manager_DuyetTNCN.aspx/HuyPheDuyetTNCN",
                type: "POST",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
