...
namespace EOSCRM.Dao
{
    ...
    public class DongMoNuocOnlineDao:BaseDao
    {
                ...
                var ListResult = _db.ExecuteQuery<KhConNo>(@"
                                                 SELECT
                                                    ...
                                                    LEFT JOIN DUONGPHO as dp ON dp.MADP = kh.MADP" +
                                                        @" WHERE tt.HETNO = 0 
	                                                AND tt.TONGTIEN > 0
	                                                AND NAM = " + dieuKienLoc.NamHd
                                                        + " AND THANG = " + dieuKienLoc.KyHd
                                                        ...
                                                        + " AND ((kh.ZALOUSERID IS NULL OR kh.ZALOUSERID = '') AND kh.isZNS = 0)"
        ...
        //public string GetBase64PDFDuyetTBQHTN(int ky, int nam, string tenDuongPho, string kvList, string idkh, string xncn, string ngayTBQH)
        //{
        //    var fontSize10 = "16.67px";
        //    var fontSize12 = "20px";
        //    var fontSize14 = "23.34px";
        //    var lineSpace = "8px";

        //    var dateTimeTBQHTN = ConvertUtil.ToDateTime(ngayTBQH);
        //    var myds = new ReportClass().KH_LocKHChuaTT(ky, nam, tenDuongPho, kvList, idkh, "TBQHTN", xncn, dateTimeTBQHTN);
        //    var GDXN = GetChuKiGDXN(xncn);
        //    var listInfoPh = new List<InfoTB>();
        ...
        //                "<meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\" />"+
        //                "<div style=\"color:white\">.</div>"+
        //                    "<div style=\"margin-top:50px; margin-left: 120px; margin-right: 120px\">" +
        ...
        //                                       "<div style=\"font-size:{0};\">CÔNG TY CỔ PHẦN CẤP NƯỚC</div>"+  
        //                                       "<div style=\"font-size:{0};\">THỪA THIÊN HUẾ</div>"+
        //                                       "<div style=\"font-size:{0}; font-weight:bold; text-decoration: underline\">XÍ NGHIỆP CẤP NƯỚC HUE</div>" +
        //                                    "</td>"+
        //                                    "<td style=\"text-align:center; vertical-align: top\">" +
        //                                       "<div style=\"font-size:{0}; font-weight:bold\">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</div>" +
        //                                       "<div style=\"font-size:{0}; font-weight:bold; text-decoration: underline\">Độc lập - Tự do - Hạnh phúc</div>" +
        //                                       "<br/>"+
        //                                       "<div style=\"font-size:{0}; font-style:italic\">Huế, ngày 18 tháng 07 năm 2024 </div>" +
        //                                    "</td>"+
        //                                "</tr>"+
        //                            "</table>"+
        //                            "<br/>"+
        ...
        //                                "<tr>" +
        //                                    "<td style=\"text-align:center\">" +
        //                                        "<div style=\"font-size:{1}; font-weight:bold\">THÔNG BÁO</div>" +
        //                                    "</td>" +
        //                                "</tr>" +
        //                                "<tr>" +
        //                                    "<td style=\"text-align:center\">" +
        //                                        "<div style=\"font-size:{1}; font-weight:bold;\">Về việc thanh toán tiền nước quá hạn</div>" +
        //                                    "</td>" +
        //                                "</tr>" +
        //                            "</table>"+
        //                            "<br/>" +
        //                            "<div style=\"margin-left: 150px\">"+
        //                                "<span style=\"font-weight:bold; text-decoration: underline; font-size:{0}\">Kính gửi</span>" +
        //                                "<span style=\"font-size:{0}\">: Khách hàng: &nbsp; &nbsp; NGUYỄN VĂN TƯỞNG</span>" +
        //                            "</div>"+
        //                        "</div>"+
        //                    "</div>"
        //                ,fontSize10
